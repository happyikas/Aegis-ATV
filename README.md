...
| [`docs/build/WHITEPAPER.pdf`](docs/build/WHITEPAPER.pdf) | **(한국어) 기술 백서 — PDF (40 pages, ~2.0 MB)** — A4 portrait, 디자인 커버 + 자동 페이지 번호 + 목차. `bash tools/whitepaper/build_pdf.sh` 로 재생성 |
