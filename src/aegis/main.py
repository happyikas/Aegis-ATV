...
def create_app(
    *,
    ...
    """Build a FastAPI app. Override key/db/log/measurement for tests."""
    ...
    app.include_router(
        _evaluate_router(key=real_key, db=real_db, log=real_log, burn_in_id=real_measurement.burn_in_id)
    )
