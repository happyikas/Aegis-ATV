...
| 5 | BLOCK | BLOCK | FP-2 | `printf` with __P1__ in argument | unchanged (Bash IS execution surface — correct) |
| 6 | BLOCK | BLOCK | FP-2 | `printf` with __P2__ in argument | unchanged (same as #5) |
| 7 | BLOCK | BLOCK | TP-3 | `printf` with __P3__ in arg | unchanged ✓ (true positive — preserved) |
...
**Phase B verification:** Call #2 (Write fixture with __P1__ in
