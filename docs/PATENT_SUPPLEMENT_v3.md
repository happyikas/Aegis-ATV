...
- [x] Reference implementation: `src/aegis/performance/`, `src/aegis/judge/unified_head.py`, `src/aegis/audit/{group_commit,tiered_archive,patrol}.py`
- [x] Unit tests: **1045 passed** (905 → 1045, +140, 1 skipped — llama-cpp 미설치)
- [x] Type-check clean: mypy 102 source files
- [x] Lint clean: ruff
